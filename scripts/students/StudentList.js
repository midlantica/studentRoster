...
const studentContainer = document.querySelector(".studentList")
...
const render = () => {
  ...
  for (const singleStudent of allStudents) {
    ...
    const foundSingleCohort = allCohorts.find(
      singleCohortObj => singleCohortObj.id === singleStudent.cohortId
    )
